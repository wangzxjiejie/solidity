...
shared_ptr<SymbolicVariable> EncodingContext::variable(solidity::frontend::VariableDeclaration const& _varDecl)
{
	solAssert(knownVariable(_varDecl), "");
	return m_variables[&_varDecl];
}

bool EncodingContext::createVariable(solidity::frontend::VariableDeclaration const& _varDecl)
{
	solAssert(!knownVariable(_varDecl), "");
...
bool EncodingContext::knownVariable(solidity::frontend::VariableDeclaration const& _varDecl)
{
	return m_variables.count(&_varDecl);
}

void EncodingContext::resetVariable(solidity::frontend::VariableDeclaration const& _variable)
{
	newValue(_variable);
	setUnknownValue(_variable);
}

void EncodingContext::resetVariables(set<solidity::frontend::VariableDeclaration const*> const& _variables)
{
	for (auto const* decl: _variables)
		resetVariable(*decl);
}

void EncodingContext::resetVariables(function<bool(solidity::frontend::VariableDeclaration const&)> const& _filter)
{
...
{
	resetVariables([&](solidity::frontend::VariableDeclaration const&) { return true; });
}

Expression EncodingContext::newValue(solidity::frontend::VariableDeclaration const& _decl)
{
	solAssert(knownVariable(_decl), "");
	return m_variables.at(&_decl)->increaseIndex();
}

void EncodingContext::setZeroValue(solidity::frontend::VariableDeclaration const& _decl)
{
	solAssert(knownVariable(_decl), "");
...
void EncodingContext::setUnknownValue(solidity::frontend::VariableDeclaration const& _decl)
{
	solAssert(knownVariable(_decl), "");
...
shared_ptr<SymbolicVariable> EncodingContext::expression(solidity::frontend::Expression const& _e)
{
...
bool EncodingContext::createExpression(solidity::frontend::Expression const& _e, shared_ptr<SymbolicVariable> _symbVar)
{
...
bool EncodingContext::knownExpression(solidity::frontend::Expression const& _e) const
{
...
bool EncodingContext::createGlobalSymbol(string const& _name, solidity::frontend::Expression const& _expr)
{
	solAssert(!knownGlobalSymbol(_name), "");
