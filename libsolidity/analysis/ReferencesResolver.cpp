...
void ReferencesResolver::operator()(yul::Identifier const& _identifier)
{
	...
	m_currentAssemblyAnnotation->externalReferences[&_identifier].isSlot = isSlot;
	m_currentAssemblyAnnotation->externalReferences[&_identifier].isOffset = isOffset;
	m_currentAssemblyAnnotation->externalReferences[&_identifier].declaration = declarations.front();
}
...
bool ReferencesResolver::visit(InlineAssembly const& _inlineAssembly)
{
	...
	m_currentAssemblyAnnotation = &_inlineAssembly.annotation();
	(this*)(_inlineAssembly.operations());
	m_currentAssemblyAnnotation = nullptr;
	return false;
}
